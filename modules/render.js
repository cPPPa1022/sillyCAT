...
import { extractImagePrompt, extractBodyContent, hasBodyMarker } from './text-utils.js';
...
export function renderBodyEnhanced(element, enhanced, startIdx, endIdx) {
    ...
    if (startIdx !== undefined && endIdx !== undefined) {
        ...
        var beforeHtml = html2.slice(0, html2.indexOf('正文###'));
        var afterHtml = html2.slice(html2.indexOf('结尾###', html2.indexOf('正文###') + 1) + 5);
...
// ── 恢复图片块（编辑后） ──
var _getChatId, _getSTContext; // 从外部注入的函数
